...
enum class ExerciseType private constructor(val code: Int, val id: Int) {
    ...
    TYPE_4(4, R.id.fragment_exercise_container),
    TYPE_5(5, R.id.fragment_exercise_container),
    TYPE_6(6, R.id.fragment_exercise_container),
    TYPE_7(7, R.id.fragment_exercise_container),
    TYPE_8(8, R.id.fragment_exercise_container),
    TYPE_9(9, R.id.fragment_exercise_container);
