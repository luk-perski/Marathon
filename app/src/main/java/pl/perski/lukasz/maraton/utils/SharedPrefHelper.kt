...
class SharedPrefHelper(context: Context) {
    ...
    var morningExercises: MutableSet<String>? = preferences.getStringSet(MORNING_EXERCISES, null)
        set(value) = preferences.edit().putStringSet(MORNING_EXERCISES, value).apply()

    var customTrainingNames: MutableSet<String>? = preferences.getStringSet(CUSTOM_TRAINING_NAMES, null)
        set(value) = preferences.edit().putStringSet(CUSTOM_TRAINING_NAMES, value).apply()

    var customTrainingExerciesSet: MutableSet<String>? = preferences.getStringSet(CUSTOM_EXERCISES_SET, null)
        set(value) = preferences.edit().putStringSet(CUSTOM_EXERCISES_SET, value).apply()

    var eveningExercises: MutableSet<String>? = preferences.getStringSet(EVENING_EXERCISES, null)
    ...
    var reminderDate: String? = preferences.getString(REMINDER_DATE, null)
